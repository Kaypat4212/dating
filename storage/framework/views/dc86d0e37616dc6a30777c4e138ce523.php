...
<head>
    ...
    ?>
    <title>Terms &amp; Conditions — <?php echo e(SS::get('site_name', config('app.name'))); ?></title>
...
<?php endif; ?>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-sm btn-outline-light rounded-pill px-3">
...
<div class="legal-hero">
    <div class="container text-center">
        ...
        <p style="color:rgba(255,255,255,.45);font-size:.9rem" class="mb-4">Last updated: <strong style="color:rgba(255,255,255,.7)"><?php echo e(\Carbon\Carbon::now()->format('F j, Y')); ?></strong> &nbsp;·&nbsp; Effective immediately</p>
...
<div class="container py-5">
    <div class="legal-body">
        ...
        <div class="highlight-box mb-4">
            <p>Please read these Terms &amp; Conditions carefully before using <strong><?php echo e(config('app.name')); ?></strong>. By accessing or using our platform, you agree to be bound by these terms. If you do not agree, please do not use the service.</p>
        </div>
        ...
        <div class="legal-section" id="eligibility">
            ...
            <h2>Eligibility</h2>
            <p>To use <?php echo e(config('app.name')); ?>, you must:</p>
            <ul>
                ...
                <li>Not have a previously terminated <?php echo e(config('app.name')); ?> account due to violations of these Terms.</li>
            </ul>
        ...
        <div class="legal-section" id="account">
            ...
            <p>When creating an account on <?php echo e(config('app.name')); ?>, you agree to:</p>
            <ul>
                ...
                <li>Notify us immediately at <a href="mailto:<?php echo e($supportEmail); ?>" style="color:#f48fb1"><?php echo e($supportEmail); ?></a> if you suspect unauthorised access to your account.</li>
        ...
        <div class="legal-section" id="conduct">
            ...
            <p><?php echo e(config('app.name')); ?> is a platform for genuine human connection. You agree <strong>not</strong> to:</p>
            <ul>
        ...
        <div class="legal-section" id="content">
            ...
            <p>You are solely responsible for all content — photos, messages, profile text, and other materials — that you post or transmit through <?php echo e(config('app.name')); ?>.</p>
            <p>By submitting content, you grant <?php echo e(config('app.name')); ?> a worldwide, royalty-free, non-exclusive, sublicensable licence to:</p>
            <ul>
        ...
        <div class="legal-section" id="premium">
            ...
            <p><?php echo e(config('app.name')); ?> offers optional paid premium features ("Premium"). By subscribing to Premium, you agree to the following:</p>
            ...
            <ul>
                ...
                <li>If you believe a charge was made in error, contact us within 30 days at <a href="mailto:<?php echo e($billingEmail); ?>" style="color:#f48fb1"><?php echo e($billingEmail); ?></a>.</li>
            </ul>
        ...
        <div class="legal-section" id="privacy">
            ...
            <h2>Privacy &amp; Data</h2>
            <p>Your privacy matters to us. Our full <a href="<?php echo e(route('legal.privacy')); ?>" style="color:#f48fb1">Privacy Policy</a> explains in detail how we collect, use, and protect your personal data. Key points:</p>
            <ul>
            ...
            <div class="info-box">
                <p><i class="bi bi-info-circle me-2" style="color:#6495ed"></i>By using <?php echo e(config('app.name')); ?>, you consent to the collection and use of your data as described in our <a href="<?php echo e(route('legal.privacy')); ?>" style="color:#9ab4f5">Privacy Policy</a>.</p>
            </div>
        </div>
        ...
        <div class="legal-section" id="safety">
            ...
            <p><?php echo e(config('app.name')); ?> is committed to your safety. However, we cannot guarantee the behaviour of other users and are not responsible for offline interactions.</p>
            <ul>
            ...
            <p>We maintain a dedicated Safety Team and partner with organisations combating online exploitation. To report serious concerns, email <a href="mailto:<?php echo e($safetyEmail); ?>" style="color:#f48fb1"><?php echo e($safetyEmail); ?></a>.</p>
        </div>
        ...
        <div class="legal-section" id="cookies">
            ...
            <h2>Cookie Policy</h2>
            <p><?php echo e(config('app.name')); ?> uses cookies and similar tracking technologies to enhance your experience. We use the following types of cookies:</p>
            <ul>
        ...
        <div class="legal-section" id="ip">
            ...
            <p>All content and materials on <?php echo e(config('app.name')); ?> — including but not limited to logos, design, code, text, graphics, and user interface elements — are owned by or licenced to <?php echo e(config('app.name')); ?> and are protected by applicable intellectual property laws.</p>
            <ul>
                ...
                <li>The <?php echo e(config('app.name')); ?> name, logo, and related marks are trademarks. Unauthorised use is prohibited.</li>
        ...
        <div class="legal-section" id="disclaimers">
            ...
            <h2>Disclaimers</h2>
            <p><?php echo e(config('app.name')); ?> is provided on an <strong>"as is"</strong> and <strong>"as available"</strong> basis, without warranties of any kind, either express or implied. We expressly disclaim:</p>
            <ul>
            ...
            <div class="warn-box">
                <p><i class="bi bi-exclamation-triangle me-2" style="color:#ffc107"></i><?php echo e(config('app.name')); ?> is a platform for meeting people, not a matchmaking service. We make no guarantee of romantic success, compatibility, or the authenticity of any user's identity.</p>
            </div>
        </div>
        ...
        <div class="legal-section" id="liability">
            ...
            <p>To the maximum extent permitted by applicable law, <?php echo e(config('app.name')); ?> and its officers, directors, employees, and partners shall not be liable for:</p>
            <ul>
        ...
        <div class="legal-section" id="community">
            ...
            <p>Beyond the conduct rules in Section 3, we ask that all members of <?php echo e(config('app.name')); ?> uphold these community standards to help us build a positive, safe environment:</p>
            <ul>
        ...
        <div class="legal-section" id="dmca">
            ...
            <p>If you believe content on <?php echo e(config('app.name')); ?> infringes your copyright, you may submit a takedown notice under the Digital Millennium Copyright Act (DMCA) by sending the following information to our Designated Copyright Agent:</p>
            <ol>
            ...
            <p>Send notices to: <a href="mailto:<?php echo e($dmcaEmail); ?>" style="color:#f48fb1"><?php echo e($dmcaEmail); ?></a></p>
        ...
        <div class="legal-section" id="governing-law">
            ...
            <p>These Terms shall be governed by and construed in accordance with applicable law. Any dispute arising out of or relating to these Terms or your use of <?php echo e(config('app.name')); ?> shall first be attempted to be resolved through good-faith negotiation.</p>
            ...
            <div class="row g-3 mt-1">
                <div class="col-12 col-sm-4">
                    <div class="p-3 rounded-3 text-center" style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07)">
                        ...
                        <a href="mailto:<?php echo e($supportEmail); ?>" style="color:#f48fb1;font-size:.85rem"><?php echo e($supportEmail); ?></a>
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="p-3 rounded-3 text-center" style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07)">
                        ...
                        <a href="mailto:<?php echo e($safetyEmail); ?>" style="color:#f48fb1;font-size:.85rem"><?php echo e($safetyEmail); ?></a>
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="p-3 rounded-3 text-center" style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07)">
                        ...
                        <a href="mailto:<?php echo e($billingEmail); ?>" style="color:#f48fb1;font-size:.85rem"><?php echo e($billingEmail); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\dating\resources\views\legal\terms.blade.php ENDPATH**/ ?>