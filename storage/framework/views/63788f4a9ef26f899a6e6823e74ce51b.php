...
<head>
    ...
    ?>
    <title>Cookie Settings — <?php echo e($siteName); ?></title>
...
<section class="page-hero text-center">
    <div class="container">
        ...
        <p class="opacity-75 mb-0" style="max-width:560px;margin:0 auto">We use cookies to keep the site working, improve your experience, and understand how people use <?php echo e($siteName); ?>. Choose what you're comfortable with.</p>
    </div>
</section>
...
<div class="container py-5" style="max-width:780px">
    ...
    <p class="mb-4" style="color:rgba(255,255,255,.5);font-size:.9rem">
        ...
        For full details see our <a href="<?php echo e(route('legal.privacy')); ?>" style="color:#f48fb1">Privacy Policy</a> and <a href="<?php echo e(route('legal.terms')); ?>#cookies" style="color:#f48fb1">Cookie Policy</a>.
    </p>
    ...
    <div class="mt-5 pt-4" style="border-top:1px solid rgba(255,255,255,.06)">
        ...
        <div class="rounded-3 overflow-hidden" style="border:1px solid rgba(255,255,255,.07)">
            <table class="table table-cookies mb-0">
                ...
                <tbody>
                    <tr>
                        <td><code style="color:#f48fb1"><?php echo e(config('session.cookie', 'heartsconnect_session')); ?></code></td>
...
<?php /**PATH C:\xampp\htdocs\dating\resources\views\pages\cookie-settings.blade.php ENDPATH**/ ?>