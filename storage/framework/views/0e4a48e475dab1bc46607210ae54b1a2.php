...
<?php $__env->startSection('title', 'Swipe'); ?>
<?php $__env->startSection('content'); ?>
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="fw-bold mb-0"><i class="bi bi-fire text-danger me-2"></i>Swipe Mode</h5>
        <a href="<?php echo e(route('discover.index')); ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-grid me-1"></i>Grid View</a>
    </div>
    ...
    <div id="swipeDeck" class="swipe-deck mx-auto" style="max-width:420px;min-height:580px;position:relative">
        ...
        <div id="emptyState" class="text-center py-5 d-none">
            ...
            <a href="<?php echo e(route('discover.index')); ?>" class="btn btn-primary">Browse All Profiles</a>
        </div>
        ...
        <div id="limitOverlay" class="d-none text-center py-5 px-3">
            ...
            <a href="<?php echo e(route('premium.show')); ?>" class="btn btn-warning fw-semibold mb-2">
                <i class="bi bi-star-fill me-1"></i>Get Premium — Unlimited Likes
            </a>
            <div><a href="<?php echo e(route('discover.index')); ?>" class="btn btn-sm btn-outline-secondary mt-2">Browse Profiles Instead</a></div>
        </div>
        ...
        <div id="restrictionOverlay" class="d-none text-center py-5 px-3">
            ...
            <a href="<?php echo e(route('pages.contact') ?? '#'); ?>" class="btn btn-outline-secondary">Contact Support</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dating\resources\views\swipe\deck.blade.php ENDPATH**/ ?>