...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'email','type' => 'email','name' => 'email','value' => old('email', $request->email),'required' => true,'autofocus' => true,'style' => 'border-left:0;border-radius:0 .85rem .85rem 0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email', $request->email)),'required' => true,'autofocus' => true,'style' => 'border-left:0;border-radius:0 .85rem .85rem 0']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'w-100 justify-content-center py-2']); ?>
            <i class="bi bi-check-circle me-2"></i><?php echo e(__('Reset Password')); ?>
...
<?php /**PATH C:\xampp\htdocs\dating\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>