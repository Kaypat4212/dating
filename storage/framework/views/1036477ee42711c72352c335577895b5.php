...
<?php $__env->startSection('title', 'AI Dating Assistant'); ?>
...
<div class="ai-chat-page">
    ...
    <div class="ai-chat-header">
        ...
        <span class="ai-limit-badge badge <?php echo e($limitClass); ?>"><?php echo e($limitText); ?></span>
    </div>
    ...
    <div class="ai-messages" id="aiMessages">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($history->isEmpty()): ?>
            <div class="ai-empty" id="aiEmpty">
                ...
                <div class="fw-semibold mb-1" style="color:#444">Hey <?php echo e($me->name); ?>! 👋</div>
        ...
        <?php else: ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="ai-bubble <?php echo e($msg->role === 'user' ? 'user' : 'bot'); ?>">
                <?php echo e($msg->body); ?>

                <div class="meta"><?php echo e($msg->created_at->format('g:i A')); ?></div>
            </div>
    ...
    <div class="ai-input-bar">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($remaining <= 0 && !$isPremium): ?>
            <div class="w-100 text-center py-2">
                <span class="text-danger small fw-semibold">
                    <i class="bi bi-clock me-1"></i>Hourly limit reached.
                </span>
                <a href="<?php echo e(route('premium.show')); ?>" class="btn btn-sm btn-warning ms-2 fw-semibold">
        ...
        <?php else: ?>
            <textarea id="aiInput"
                      ...
                      rows="1"
                      maxlength="600"
                      <?php echo e(($remaining <= 0 && !$isPremium) ? 'disabled' : ''); ?>></textarea>
...
(function () {
    ...
    const replyUrl = '<?php echo e(route('ai.chat.reply')); ?>';
        ...
        try {
            ...
            if (typeof data.remaining !== 'undefined') {
                ...
                if (badge) {
                    ...
                    badge.textContent = r < 0 ? '∞ Unlimited' : `${r} / <?php echo e($limit); ?> left this hour`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dating\resources\views\conversations\ai-chat.blade.php ENDPATH**/ ?>