            ...
            <div class="d-flex align-items-center gap-2 mt-2 mt-lg-0">
                ...
                <div class="dropdown" style="position:relative">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 navbar-dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('extras.pets')); ?>"><i class="bi bi-heart-fill me-2 text-warning"></i>My Pets</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('icebreaker.index')); ?>"><i class="bi bi-snow2 me-2 text-info"></i>Icebreakers</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('account.show')); ?>"><i class="bi bi-gear me-2 text-secondary"></i>Settings</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('invite.index')); ?>"><i class="bi bi-gift me-2 text-danger"></i>Invite Friends</a></li>
...
<script src="<?php echo e(asset('js/pwa-badge.js')); ?>"></script>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
