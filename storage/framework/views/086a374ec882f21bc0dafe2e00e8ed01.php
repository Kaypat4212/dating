    ...
    <div id="swipe-stack">
        ...
        <div class="swipe-card <?php echo e($isTop ? 'is-top' : ''); ?>"
            ...
            <div class="card-info">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prof?->city || $prof?->country): ?>
                <div class="card-meta">
                    <i class="bi bi-geo-alt me-1"></i><?php echo e(implode(', ', array_filter([$prof->city, $prof->country]))); ?>
        ...
        if (!data.profiles?.length) {
            document.getElementById('swipe-stack').innerHTML =
                `<div class="text-center p-5 text-white"><div class="display-1">🌍</div>
                 ...
                 <a href="<?php echo e(route('preferences.edit')); ?>" class="btn btn-primary mt-2">
...
showLimitOverlay(new Date('<?php echo e($limitResetAt); ?>'));
<?php endif; ?>
</script>
