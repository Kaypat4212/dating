...
<?php $component->withAttributes(['class' => 'w-100 justify-content-center py-2']); ?>
            <i class="bi bi-send me-2"></i><?php echo e(__('Send Reset Link')); ?>
...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('password.secret')); ?>"
    ...
    <p class="text-center mt-4 mb-0 small" style="color:rgba(255,255,255,0.45)">
        <a href="<?php echo e(route('login')); ?>" class="auth-link"><i class="bi bi-arrow-left me-1"></i>Back to Sign In</a>
    </p>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\dating\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>