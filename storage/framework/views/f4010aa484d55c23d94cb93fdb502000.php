...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'email','type' => 'email','name' => 'email','value' => old('email'),'required' => true,'autofocus' => true,'autocomplete' => 'username','style' => 'border-left:0;border-radius:0 .85rem .85rem 0','placeholder' => 'you@example.com']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true,'autocomplete' => 'username','style' => 'border-left:0;border-radius:0 .85rem .85rem 0','placeholder' => 'you@example.com']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <div class="input-group">
                ...
                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','type' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password','style' => 'border-left:0;border-radius:0 .85rem .85rem 0','placeholder' => 'Enter your password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','type' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password','style' => 'border-left:0;border-radius:0 .85rem .85rem 0','placeholder' => 'Enter your password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex flex-column align-items-end gap-1">
                ...
                <a href="<?php echo e(route('password.secret')); ?>" class="small" style="color:rgba(255,255,255,0.35);text-decoration:none" onmouseover="this.style.color='#f48fb1'" onmouseout="this.style.color='rgba(255,255,255,0.35)'">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-100 justify-content-center py-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-100 justify-content-center py-2']); ?>
...
<?php endif; ?>
        ...
        <p class="text-center mb-0 small" style="color:rgba(255,255,255,0.45)">
            Don't have an account? <a href="<?php echo e(route('register')); ?>" class="auth-link">Join Free</a>
        </p>
    </form>
    ...
    <div class="mt-4 rounded-3 p-3" style="background:rgba(0,0,0,0.25);border:1px dashed rgba(255,255,255,0.15)">
        ...
        <div class="d-flex flex-column gap-2">
            <button type="button"
                onclick="fillLogin(<?php echo \Illuminate\Support\Js::from($devAdminEmail)->toHtml() ?>,'admin123')"
                ...
                <i class="bi bi-shield-fill me-1"></i>Admin &mdash; <span class="opacity-75 fw-normal"><?php echo e($devAdminEmail); ?> / admin123</span>
            </button>
            <button type="button"
                onclick="fillLogin(<?php echo \Illuminate\Support\Js::from($devDemoEmail)->toHtml() ?>,'password')"
                class="btn btn-sm w-100 fw-semibold"
                style="background:rgba(100,200,255,0.12);border:1px solid rgba(100,200,255,0.3);color:#81d4fa;border-radius:.75rem">
                <i class="bi bi-person-fill me-1"></i>Demo User &mdash; <span class="opacity-75 fw-normal"><?php echo e($devDemoEmail); ?> / password</span>
            </button>
        </div>
    </div>
    <script>
...
<?php /**PATH C:\xampp\htdocs\dating\resources\views\auth\login.blade.php ENDPATH**/ ?>