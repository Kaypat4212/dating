      ...
      <form id="fundWalletForm" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="mb-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="card mb-3 border">
                <div class="card-body py-3 px-3">
                  <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                    <div>
                      <span class="badge bg-primary me-1"><?php echo e($w->currency); ?></span>
                      <span class="text-muted small"><?php echo e($w->network); ?></span>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($w->label): ?>
                        <span class="text-secondary small ms-1">— <?php echo e($w->label); ?></span>
                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                  </div>
                  <div class="d-flex align-items-center gap-2 mb-2">
                    <code class="flex-grow-1 bg-light rounded px-2 py-1 small" style="word-break:break-all"><?php echo e($w->address); ?></code>
                    <button type="button" class="btn btn-sm btn-outline-secondary copy-addr-btn flex-shrink-0" data-address="<?php echo e($w->address); ?>" title="Copy address">
                      <i class="bi bi-copy"></i>
                    </button>
                  </div>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($w->qr_code_path): ?>
                    <div class="text-center mt-2">
                      <img src="<?php echo e(asset('storage/'.$w->qr_code_path)); ?>" class="img-thumbnail" style="max-width:140px;max-height:140px" alt="QR Code for <?php echo e($w->display_name); ?>">
      ...
      <form id="withdrawWalletForm">
        ...
        <div class="modal-body">
          ...
          <div class="alert alert-secondary py-2 px-3 mb-4 d-flex align-items-center justify-content-between">
            ...
            <span class="fw-bold fs-5" id="withdraw-balance-display"><?php echo e(auth()->user()->credit_balance); ?> <span class="text-muted small fw-normal">credits</span></span>
          </div>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wallets->isNotEmpty()): ?>
          <div class="mb-4">
            <div class="fw-semibold mb-2">Select Payout Crypto <span class="text-danger">*</span></div>
            <div class="row g-2" id="crypto-selector">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="col-12 col-sm-6">
                <label class="d-block cursor-pointer">
                  <input type="radio" name="_crypto_pick" class="d-none crypto-radio"
                         data-currency="<?php echo e($w->currency); ?>" data-network="<?php echo e($w->network ?? ''); ?>" value="<?php echo e($w->id); ?>">
                  <div class="card border-2 crypto-pick-card h-100" style="cursor:pointer;transition:border-color .15s,background .15s">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-3">
                      ...
                      <div>
                        <div class="fw-bold"><?php echo e($w->currency); ?></div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($w->network): ?><div class="text-muted small"><?php echo e($w->network); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($w->label): ?><div class="text-secondary" style="font-size:.75rem"><?php echo e($w->label); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                      </div>
...
const BASE = '<?php echo e(rtrim(config("app.url"), "/")); ?><?php echo e(config("app.subdir", "")); ?>';
const CREDITS_PER_USD = <?php echo e((float) ($creditsPerUsd ?? 10)); ?>;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('fundWalletForm').onsubmit = async function(e) {
    ...
    try {
      const r = await fetch('<?php echo e(route("wallet.fund")); ?>', {
        method: 'POST',
  ...
  document.getElementById('withdrawWalletForm').onsubmit = async function(e) {
    ...
    try {
      const r = await fetch('<?php echo e(route("wallet.withdraw")); ?>', {
        method: 'POST',
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\dating\resources\views\wallet\_modals.blade.php ENDPATH**/ ?>