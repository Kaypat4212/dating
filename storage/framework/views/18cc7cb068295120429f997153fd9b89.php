    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="loc-card">
                ...
                <div class="p-4">
                    <form method="POST" action="<?php echo e(route('setup.store', 4)); ?>" id="step4Form">
                        <?php echo csrf_field(); ?>
                        <?php
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-6">
                                ...
                                <input type="text" name="city" id="setupCity" class="form-control loc-input"
                                       ...
                                       value="<?php echo e(old('city', session('setup.city'))); ?>" required>
                            </div>
                            <div class="col-6">
                                <label class="loc-field-label">
                                    Country
                                ...
                                <select name="country" id="setupCountry" class="form-select loc-select" required>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Helpers\CountryHelper::list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($name); ?>" <?php echo e($setupCountry === $name ? 'selected' : ''); ?>>
                                            <?php echo e($name); ?>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <select name="preferred_state" id="setupPrefStateSelect" class="form-select loc-select">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Helpers\StateHelper::forCountry($setupCountry); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($s); ?>" <?php echo e($setupPrefState === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
                                <input type="text" name="preferred_state" id="setupPrefStateText"
                                       class="form-control loc-input d-none"
                                       placeholder="Preferred state"
                                       value="<?php echo e($setupPrefState); ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <span id="distLabel" class="fw-bold" style="color:#e91e8c;font-size:.85rem">
                                        <?php echo e(old('max_distance_km', session('setup.max_distance_km', 50))); ?> km
                                    </span>
                            ...
                            <input type="range" id="setup-dist" name="max_distance_km" class="form-range loc-range"
                                   ...
                                   value="<?php echo e(old('max_distance_km', session('setup.max_distance_km', 50))); ?>">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                ...
                                <input type="number" name="min_age" class="form-control loc-input"
                                       value="<?php echo e(old('min_age', session('setup.min_age', 18))); ?>" min="18" max="80">
                            </div>
                            <div class="col-6">
                                <label class="loc-field-label">Max Age Preference</label>
                                <input type="number" name="max_age" class="form-control loc-input"
                                       value="<?php echo e(old('max_age', session('setup.max_age', 60))); ?>" min="18" max="99">
                            </div>
                        </div>

                        
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('setup.step', 3)); ?>" class="btn-back flex-fill d-flex align-items-center justify-content-center gap-2 text-decoration-none">
