...
<?php $__env->startSection('title', 'Get the App'); ?>
<?php $__env->startSection('content'); ?>
<?php $appName = \App\Models\SiteSetting::get('site_name', config('app.name')); ?>
...
<div class="container py-5" style="max-width:680px">
    ...
    <div id="alreadyInstalled" class="alert alert-success d-none mb-4" role="alert">
        ...
        <strong><?php echo e($appName); ?></strong> is already installed on your device!
        <a href="<?php echo e(route('dashboard')); ?>" class="alert-link ms-1">Open the app →</a>
    </div>

    <div class="text-center mb-5">
        <?php $icon = \App\Models\SiteSetting::get('site_favicon'); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($icon): ?>
        <img src="<?php echo e(asset('storage/' . $icon)); ?>" alt="<?php echo e($appName); ?>" width="80" height="80"
             class="rounded-3 shadow-sm mb-3" style="object-fit:contain">
        <?php else: ?>
        <div class="display-3 mb-3">💕</div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <h1 class="fw-bold fs-2">Get the <?php echo e($appName); ?> App</h1>
    ...
    <div id="autoInstallSection" class="card border-0 shadow-sm mb-4 d-none">
        <div class="card-body p-4 text-center">
            ...
            <p class="text-muted small mb-3">Your browser detected <?php echo e($appName); ?> can be installed as an app.</p>
            <button id="autoInstallBtn" class="btn btn-primary btn-lg px-5 shadow-sm">
                <i class="bi bi-download me-2"></i>Install <?php echo e($appName); ?>
        ...
        <div class="card-body px-4 pb-4 pt-3">
            <div class="tab-content" id="platformTabContent">
                ...
                <div class="tab-pane fade show active" id="android" role="tabpanel">
                    <ol class="list-group list-group-flush list-group-numbered">
                        <li class="list-group-item px-0">
                            Open <strong><?php echo e(url('/')); ?></strong> in
                        ...
                        <li class="list-group-item px-0">
                            <?php echo e($appName); ?> now appears on your home screen. Open it anytime — no browser bar! 🎉
                        </li>
                    </ol>
                </div>
                ...
                <div class="tab-pane fade" id="ios" role="tabpanel">
                    ...
                    <ol class="list-group list-group-flush list-group-numbered">
                        <li class="list-group-item px-0">
                            Open <strong><?php echo e(url('/')); ?></strong> in <strong>Safari</strong>.
                        </li>
                        <li class="list-group-item px-0">
                        ...
                        <li class="list-group-item px-0">
                            <?php echo e($appName); ?> now appears on your home screen with a full-screen experience! 🎉
                        </li>
                    </ol>
                </div>
                ...
                <div class="tab-pane fade" id="desktop" role="tabpanel">
                    ...
                    <ol class="list-group list-group-flush list-group-numbered">
                        <li class="list-group-item px-0">
                            Open <strong><?php echo e(url('/')); ?></strong> in Chrome or Edge.
                        </li>
                        <li class="list-group-item px-0">
                        ...
                        <li class="list-group-item px-0">
                            <em>Alternatively:</em> Open the browser <strong>menu (⋮)</strong> → <strong>"Install <?php echo e($appName); ?>"</strong>.
                        </li>
                        <li class="list-group-item px-0">
                            <?php echo e($appName); ?> opens in its own window — like a native desktop app! 🎉
                        </li>
                    </ol>
                </div>
        ...
        prompt.userChoice.then(function (choice) {
            if (choice.outcome === 'accepted') {
                ...
                document.getElementById('autoInstallSection').innerHTML =
                    ...
                    '<p class="text-muted small">Launch <?php echo e($appName); ?> from your home screen anytime.</p></div>';
            }
        });
    });
})();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dating\resources\views\pwa\install.blade.php ENDPATH**/ ?>