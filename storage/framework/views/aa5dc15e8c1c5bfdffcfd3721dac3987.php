                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="button" class="btn btn-outline-secondary report-btn"
                                data-user="<?php echo e($profileUser->id); ?>"
                                data-name="<?php echo e($profileUser->name); ?>"
                                title="Report <?php echo e($profileUser->name); ?>"
                                aria-label="Report <?php echo e($profileUser->name); ?>">
                            ...
                            <button type="button" class="btn btn-outline-danger block-btn"
                                data-user="<?php echo e($profileUser->id); ?>"
                                data-name="<?php echo e($profileUser->name); ?>"
                                title="Block <?php echo e($profileUser->name); ?>"
                                aria-label="Block <?php echo e($profileUser->name); ?>">
...
<div class="modal fade" id="reportModal" tabindex="-1" aria-hidden="true" aria-labelledby="reportModalLabel">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form method="POST" id="reportForm" action="<?php echo e(route('report.store', $profileUser->id)); ?>">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="reported_user_id" value="<?php echo e($profileUser->id); ?>">
        <div class="modal-body">
...
document.getElementById('block-confirm-btn').addEventListener('click', () => {
    ...
    fetch('<?php echo e(route("block.store", ":u")); ?>'.replace(':u', _blockTargetBtn.dataset.user), {
        method: 'POST',
        headers: { 'X-CSRF-TOKEN': csrf, 'Content-Type': 'application/json' },
    })
    .then(r => r.json())
