...
<?php $__env->startSection('title', 'Chat with ' . $other->name); ?>
...
<div class="chat-page">
    ...
    <div class="chat-header">
        ...
        <a href="<?php echo e($other->username ? route('profile.show', $other->username) : '#'); ?>"
           class="d-flex align-items-center gap-2 text-decoration-none text-reset flex-grow-1 overflow-hidden">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($other->primaryPhoto): ?>
                <img src="<?php echo e($other->primaryPhoto->thumbnail_url); ?>"
                     class="chat-header-avatar" alt="<?php echo e($other->name); ?>">
            <?php else: ?>
                <div class="chat-header-avatar-ph"><?php echo e(strtoupper(mb_substr($other->name, 0, 1))); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="overflow-hidden">
                <div class="fw-semibold lh-1 mb-1 text-truncate">
                    <?php echo e($other->name); ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($other->is_verified ?? false): ?>
                        <i class="bi bi-patch-check-fill text-info ms-1" style="font-size:.8rem" title="Verified"></i>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <div id="chatStatusLine" class="chat-status-line <?php echo e($isOnline ? 'chat-status-online' : ''); ?>">
                    ...
                    <?php elseif($visibleLastSeen): ?>
                        Active <?php echo e($visibleLastSeen->diffForHumans()); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allMatches->isNotEmpty()): ?>
    <div class="matches-stories-container">
        <div class="matches-stories">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matchItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $matchUser = $matchItem->user;
                    $isCurrent = $matchUser->id === $other->id;
                ?>
                <a href="<?php echo e(route('conversations.show', $matchItem->conversationId)); ?>" 
                   class="story-item <?php echo e($isCurrent ? 'opacity-50' : ''); ?>">
                    <div class="story-avatar-ring">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($matchUser->primaryPhoto): ?>
                            <img src="<?php echo e($matchUser->primaryPhoto->thumbnail_url); ?>" 
                                 alt="<?php echo e($matchUser->name); ?>" 
                                 class="story-avatar">
                        <?php else: ?>
                            <div class="story-avatar-ph">
                                <?php echo e(strtoupper(substr($matchUser->name, 0, 1))); ?>

                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($matchItem->isOnline): ?>
                            <div class="story-online-dot"></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <span class="story-name"><?php echo e($matchUser->name); ?></span>
                </a>
    ...
    <div class="chat-body-scroll" id="chatBody">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $msgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($date !== $prevDate): ?>
            <?php $prevDate = $date; ?>
            <div class="date-sep">
                <?php echo e($msg->created_at->isToday() ? 'Today' : ($msg->created_at->isYesterday() ? 'Yesterday' : $msg->created_at->format('M j, Y'))); ?>

            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <div class="msg-row <?php echo e($isMe ? 'me' : 'them'); ?> <?php echo e($isFirst ? 'group-start' : ''); ?>">

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isMe): ?>
            <div class="msg-avatar-cell <?php echo e($isLast ? '' : 'hidden'); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($msg->sender?->primaryPhoto): ?>
                    <img src="<?php echo e($msg->sender->primaryPhoto->thumbnail_url); ?>" alt="<?php echo e($msg->sender->name ?? ''); ?>">
                <?php else: ?>
                    <div class="av-ph"><?php echo e(strtoupper(mb_substr($msg->sender->name ?? '?', 0, 1))); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="message-bubble <?php echo e($isMe ? 'me' : 'them'); ?> <?php echo e(!$isFirst ? 'not-first' : ''); ?> <?php echo e(!$isLast ? 'not-last' : ''); ?> position-relative <?php echo e($msg->isImage() || $msg->isAudio() ? 'media-bubble' : ''); ?>"
                 data-msg-id="<?php echo e($msg->id); ?>">

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($msg->isImage()): ?>
                    
                    <a href="<?php echo e($msg->attachment_url); ?>" target="_blank" class="msg-img-link">
                        <img src="<?php echo e($msg->attachment_url); ?>"
                             alt="<?php echo e($msg->attachment_name ?? 'Image'); ?>"
                             class="msg-image"
                             loading="lazy">
                    </a>
                <?php elseif($msg->isAudio()): ?>
                    
                    <div class="msg-audio">
                        <i class="bi bi-music-note-beamed me-2 text-primary"></i>
                        <audio controls preload="none" class="msg-audio-player">
                            <source src="<?php echo e($msg->attachment_url); ?>" type="<?php echo e($msg->attachment_mime ?? 'audio/mpeg'); ?>">
                        </audio>
                        <div class="msg-audio-name text-truncate small mt-1 text-muted"><?php echo e($msg->attachment_name); ?></div>
                    </div>
                <?php elseif($msg->type === 'gift'): ?>
                    
                    <div class="gift-bubble text-center px-3 py-2">
                        <div style="font-size:2.5rem;line-height:1"><?php echo e(explode(' ', $msg->body)[0]); ?></div>
                        <div class="small fw-semibold mt-1" style="color:#c2185b"><?php echo e(implode(' ', array_slice(explode(' ', $msg->body), 1))); ?></div>
                ...
                <div class="message-meta d-flex align-items-center gap-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMe): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($msg->read_at): ?>
                            <i class="bi bi-check2-all text-primary" title="Seen <?php echo e($msg->read_at->format('g:i A')); ?>"></i>
                        <?php else: ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reactions->isNotEmpty()): ?>
                <div class="msg-reactions">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $reactions->groupBy('emoji'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="reaction-badge"><?php echo e($emoji); ?><?php echo e($group->count() > 1 ? ' '.$group->count() : ''); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($msg->type === 'text'): ?>
                <div class="reaction-picker-trigger" title="React">+</div>
                <div class="reaction-picker d-none" data-msg="<?php echo e($msg->id); ?>"></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        ...
        <div id="typingRow" class="msg-row them group-start d-none">
            <div class="msg-avatar-cell">
                ...
                <?php else: ?>
                    <div class="av-ph"><?php echo e(strtoupper(mb_substr($other->name, 0, 1))); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><i class="bi bi-coin text-warning me-2"></i>Send a Tip to <?php echo e($other->name); ?></h5>
          ...
          <form id="chatTipForm">
            ...
            <div class="modal-body">
              <div class="d-flex align-items-center gap-2 mb-3 p-2 rounded-3" style="background:var(--bs-secondary-bg)">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($other->primaryPhoto): ?>
                  <img src="<?php echo e($other->primaryPhoto->thumbnail_url); ?>" class="rounded-circle" style="width:38px;height:38px;object-fit:cover" alt="">
                <?php else: ?>
                  <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold" style="width:38px;height:38px;background:linear-gradient(135deg,#7c3aed,#ec4899);color:#fff"><?php echo e(strtoupper(mb_substr($other->name,0,1))); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div>
                  <div class="fw-semibold lh-1"><?php echo e($other->name); ?></div>
...
(function () {
    ...
    const GIFTS = [
        { emoji: '\uD83C\uDF39', label: 'Rose',      price: <?php echo e((int) ($giftPrices['gift_price_rose']      ?? 10)); ?> },
        { emoji: '\uD83D\uDC96', label: 'Heart',     price: <?php echo e((int) ($giftPrices['gift_price_heart']     ?? 10)); ?> },
        { emoji: '\uD83C\uDF81', label: 'Gift Box',  price: <?php echo e((int) ($giftPrices['gift_price_gift_box']  ?? 10)); ?> },
        { emoji: '\uD83C\uDF6B', label: 'Chocolate', price: <?php echo e((int) ($giftPrices['gift_price_chocolate'] ?? 10)); ?> },
        { emoji: '\u2B50',       label: 'Star',      price: <?php echo e((int) ($giftPrices['gift_price_star']      ?? 10)); ?> },
        { emoji: '\uD83D\uDC8E', label: 'Diamond',   price: <?php echo e((int) ($giftPrices['gift_price_diamond']   ?? 10)); ?> },
        { emoji: '\uD83C\uDF38', label: 'Flower',    price: <?php echo e((int) ($giftPrices['gift_price_flower']    ?? 10)); ?> },
        { emoji: '\uD83D\uDC8C', label: 'Love',      price: <?php echo e((int) ($giftPrices['gift_price_love']      ?? 10)); ?> },
    ];
    ...
    if (giftBtn && giftPopover) {
        ...
        giftPopover.addEventListener('click', async e => {
            ...
            try {
                const balRes  = await fetch('<?php echo e(route("wallet.balance")); ?>');
                const balData = await balRes.json();
                const balance = parseInt(balData.balance ?? 0, 10);
                if (price > 0 && balance < price) {
                    _giftToast('Not enough credits to send this gift. <a href="<?php echo e(route("wallet.index")); ?>" class="toast-link text-white fw-semibold">Fund wallet</a>', 'danger');
                    return;
                }
            } catch {
    ...
    const partnerId   = <?php echo e($other->id); ?>;
    const aiRoute     = '<?php echo e(route('ai.suggest')); ?>';
        ...
        chatTipBtn?.addEventListener('click', () => {
            ...
            fetch('<?php echo e(route("wallet.balance")); ?>')
                ...
                .then(d => {
                    ...
                    if (_tipBal <= 0) {
                        tipAlert('warning', '<i class="bi bi-exclamation-triangle me-1"></i>No credits. <a href="<?php echo e(route("wallet.index")); ?>" class="alert-link fw-semibold">Fund your wallet</a>.');
                        chatTipSubmit.disabled = true;
                    }
                })
        ...
        chatTipForm?.addEventListener('submit', async (e) => {
            ...
            try {
                const res = await fetch('<?php echo e(route("tips.send")); ?>', {
                    ...
                    body: JSON.stringify({ recipient_id: <?php echo e($other->id); ?>, amount: amt, message: chatTipMsgEl.value.trim() || null }),
                });
                const data = await res.json();
                if (!res.ok) {
                    ...
                    tipAlert('success', `<i class="bi bi-check-circle me-1"></i>Tip of <strong>${amt}</strong> credits sent to <strong><?php echo e($other->name); ?></strong>!`);
                    _tipBal -= amt;
                    chatTipBalEl.textContent = _tipBal;
                    chatTipAmtEl.value = '';
                    chatTipMsgEl.value = '';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dating\resources\views\conversations\show.blade.php ENDPATH**/ ?>