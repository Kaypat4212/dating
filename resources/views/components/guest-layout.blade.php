...
<body class="auth-page">
    ...
    (function () {
        ...
        function createParticle() {
            ...
            el.style.animationDuration = (Math.random() * (maxTime - minTime) + minTime) + 'ms';
            el.style.animationDelay = Math.random() * 2000 + 'ms';

            wrap.appendChild(el);

            setTimeout(() => {
                if (el.parentNode) el.parentNode.removeChild(el);
            }, parseFloat(el.style.animationDuration) + 1000);
        }
