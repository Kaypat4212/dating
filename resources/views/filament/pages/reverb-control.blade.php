            ...
            <div class="server-card mb-4">
                ...
                <div>
                    <div class="config-item">
                        ...
                        <code class="text-white">{{ env('REVERB_HOST', 'localhost') }}</code>
                    </div>
                    <div class="config-item">
                        <span class="text-white-50">Port</span>
                        <code class="text-white">{{ env('REVERB_PORT', 8080) }}</code>
                    </div>
                    <div class="config-item">
                        <span class="text-white-50">Scheme</span>
                        <code class="text-white">{{ env('REVERB_SCHEME', 'http') }}</code>
                    </div>
                    <div class="config-item">
                        <span class="text-white-50">App ID</span>
                        <code class="text-white">{{ env('REVERB_APP_ID', 'dating-app') }}</code>
                    </div>
                </div>
            </div>
