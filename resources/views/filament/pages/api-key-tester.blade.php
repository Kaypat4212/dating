...
$services = [
    ...
    [
        ...
        'description' => 'Powers real-time voice and video calls between matched users. Free tier includes 10,000 participant-minutes/month. If no key is set the app automatically falls back to Jitsi Meet (completely free, no account needed).',
        'howto'       => "1. Sign up at daily.co\n2. Go to Dashboard → Developers → API Keys\n3. Copy your API key → set DAILY_CO_API_KEY=...\n4. Your subdomain (e.g. 'heartsconnect') → set DAILY_CO_DOMAIN=heartsconnect\n5. Optional: leave blank to use free Jitsi Meet fallback",
        'docs_url'    => 'https://dashboard.daily.co',
    ],
    [
        'id'          => 'agora',
        'label'       => 'Agora (Legacy)',
        'subtitle'    => 'Voice & Video (Legacy)',
        'group'       => 'Calls',
        'icon'        => 'heroicon-o-phone',
        'method'      => 'testAgora',
        'env_keys'    => ['AGORA_APP_ID', 'AGORA_APP_CERTIFICATE'],
        'description' => 'Original WebRTC provider. The app has migrated to Daily.co but Agora keys are kept for backward compatibility. These will be used if Daily.co is not configured and Jitsi Meet is unavailable.',
        'howto'       => "1. Sign up at console.agora.io\n2. Create a new project\n3. Enable 'App Certificate' in the project settings\n4. Copy App ID → set AGORA_APP_ID=...\n5. Copy Primary Certificate → set AGORA_APP_CERTIFICATE=...",
