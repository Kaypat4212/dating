    ...
    <div class="max-w-2xl w-full">
            ...
            <div class="p-8">
                    ...
                    <div class="flex items-start gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Our security system detected that you're accessing {{ config('app.name') }} through a VPN, proxy, or anonymous network. 
                ...
                <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                    ...
                    <ul class="text-sm text-red-700 space-y-1 ml-6">
                        ...
                        @if($provider)
                            <li>Detected Provider: <strong>{{ $provider }}</strong></li>
                        @endif
                ...
                <div class="mb-6">
                    ...
                    <ol class="space-y-3 text-gray-700">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span><strong>Try again</strong> - Once disconnected from VPN, refresh this page or try accessing {{ config('app.name') }} again.</span>
                        </li>
                    </ol>
                </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="mailto:{{ $support_email }}" class="text-rose-600 hover:text-rose-700 font-semibold underline">contact our support team</a> 
                        with your IP address: <code class="bg-gray-100 px-2 py-1 rounded text-xs">{{ request()->ip() }}</code>
                    </p>
                </div>
            </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
            <p>
                ...
                Detection Time: {{ now()->format('F j, Y g:i A') }}
            </p>
        </div>
    </div>
</body>
