...
<head>
    ...
    @endphp
    <title>Help Center — {{ $siteName }}</title>
...
<section class="page-hero text-center">
    <div class="container">
        ...
        <p class="opacity-75 mb-4">Find answers to common questions about {{ $siteName }}.</p>
...
<div class="container py-5" style="max-width:860px">
    ...
    <div class="accordion" id="faqGettingStarted">
        ...
        <div class="accordion-item faq-item">
            <h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">Is {{ $siteName }} free to use?</button></h2>
    ...
    <div class="accordion" id="faqPremium">
        ...
        <div class="accordion-item faq-item">
            ...
            <div id="faq14" class="accordion-collapse collapse"><div class="accordion-body">We accept crypto-currency payments for complete privacy. See the <a href="{{ route('premium.show') }}" style="color:#6495ed">Premium page</a> for supported currencies. Your payment details are never linked to your profile.</div></div>
        </div>
    </div>
    ...
    <div class="accordion" id="faqSafety">
        <div class="accordion-item faq-item">
            ...
            <div id="faq15" class="accordion-collapse collapse"><div class="accordion-body">On any profile, tap the <em>⋮ menu</em> → <strong>Report</strong>. Select the reason and optionally add details. Our moderation team reviews every report. You can also visit our <a href="{{ route('pages.report-abuse') }}" style="color:#6495ed">Report Abuse</a> page to contact us directly for urgent matters.</div></div>
        </div>
        <div class="accordion-item faq-item">
    ...
    <div class="accordion" id="faqBilling">
        <div class="accordion-item faq-item">
            ...
            <div id="faq18" class="accordion-collapse collapse"><div class="accordion-body">Premium access automatically expires at the end of the period you paid for — there are no recurring charges. If you'd like a refund for unused time, contact our <a href="{{ route('pages.contact') }}" style="color:#6495ed">billing support</a>.</div></div>
        </div>
        <div class="accordion-item faq-item">
            ...
            <div id="faq19" class="accordion-collapse collapse"><div class="accordion-body">Refund requests are handled on a case-by-case basis. Please <a href="{{ route('pages.contact') }}" style="color:#6495ed">contact our billing team</a> with your payment reference within 7 days of purchase and we'll review your request.</div></div>
        </div>
    </div>
    ...
    <div class="mt-5 pt-4 text-center" style="border-top:1px solid rgba(255,255,255,.06)">
        ...
        <a href="{{ route('pages.contact') }}" class="btn rounded-pill px-4 py-2 fw-semibold" style="background:linear-gradient(135deg,#ff6b9d,#c44ee0);color:#fff;border:none">
