...
<head>
    ...
    @endphp
    <title>Safety Tips — {{ $siteName }}</title>
    ...
    <div class="row g-3 mb-5">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="tip-card">
                ...
                <p>Use {{ $siteName }}'s built-in messaging until you feel comfortable. Moving off-platform removes your ability to report or block the person easily.</p>
            </div>
        </div>
        <div class="col-md-6 col-lg-4">
            <div class="tip-card">
        ...
        <div class="d-flex align-items-start gap-3">
            ...
            <div>
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('pages.report-abuse') }}" class="btn btn-sm fw-semibold rounded-pill px-3" style="background:rgba(255,87,87,.2);border:1px solid rgba(255,87,87,.4);color:#ff5757">
                        <i class="bi bi-flag me-1"></i>Report Abuse
                    </a>
                    <a href="mailto:{{ $safetyEmail }}" class="btn btn-sm fw-semibold rounded-pill px-3" style="background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);color:rgba(255,255,255,.7)">
