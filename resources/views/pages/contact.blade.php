    ...
    <div class="row g-4">
        ...
        <div class="col-lg-7">
            <div class="contact-card">
                ...
                <form method="POST" action="{{ route('pages.contact.submit') }}" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-sm-6">
        ...
        <div class="col-lg-5 d-flex flex-column gap-3">
            <div class="info-tile">
                ...
                <div>
                    ...
                    <a href="mailto:{{ $supportEmail }}" style="color:#f48fb1;font-size:.875rem;word-break:break-all">{{ $supportEmail }}</a>
            ...
            <div class="info-tile">
                ...
                <div>
                    ...
                    <a href="{{ route('pages.help-center') }}" style="color:#f48fb1;font-size:.875rem">Visit Help Center →</a>
                </div>
            </div>
            ...
            <div class="info-tile">
                ...
                <div>
                    ...
                    <a href="{{ route('pages.report-abuse') }}" style="color:#ff5757;font-size:.875rem">Report Abuse →</a>
                </div>
            </div>
        </div>
