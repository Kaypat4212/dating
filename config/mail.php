    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            // NOTE: The 'stream.ssl' options below are IGNORED by Symfony Mailer
            // (Laravel 9+).  The actual SSL peer bypass is handled via
            // Mail::extend('smtp', ...) in AppServiceProvider::boot().
            // Kept here only as documentation of the intent.
            'stream' => [
                'ssl' => [
                    'verify_peer'      => false,
